...
// // components/Sidebar.jsx - Updated with Cell Level Support
// import React, { useState } from 'react';
// import { useLocation, useNavigate } from 'react-router-dom';
// import { 
//   AlertTriangle, Bell, Users, Shield, MapPin, FileText, Settings, 
...
//   // ✅ UPDATED: Get user level info with Cell Level support
//   const getUserLevelInfo = (userType) => {
//     const levels = {
//       citizen: { 
//         label: 'Citizen', 
...
//       sector: { 
//         label: 'Sector Level', 
//         icon: Building2,  // Changed from Building to Building2
//         color: 'bg-cyan-500/20',  // Changed color to differentiate from cell
//         textColor: 'text-cyan-300',
//         borderColor: 'border-cyan-500/30',
//         level: 3  // Changed from 2 to 3
//       },
//       district: { 
//         label: 'District Level', 
//         icon: Layers, 
...
//         textColor: 'text-gray-300',
//         borderColor: 'border-gray-500/30',
//         level: 7  // Changed from 6 to 7
//       }
//     };
//     return levels[userType] || levels.citizen;
//   };

//   // ✅ UPDATED: Get escalation target with Cell Level support
//   const getEscalationTarget = (userType) => {
//     const escalationMap = {
//       village: 'Cell',      // ✅ CHANGED: Village escalates to Cell (was 'Sector')
//       cell: 'Sector',       // ✅ ADDED: Cell escalates to Sector
//       sector: 'District',   // Changed from 'Province'
//       district: 'Province',
//       province: 'National',
//       national: 'Central Command',
//       admin: null,
...
//   // ✅ UPDATED: Comprehensive nav items with Cell Level support
//   const getAllNavigationItems = () => {
//     const userType = user?.user_type;
//     const escalationTarget = getEscalationTarget(userType);
//     const adminLevel = getUserAdminLevel();
...
//               userType === 'citizen' ? '/citizen/dashboard' :
//               userType === 'village' ? '/village/dashboard' :
//               userType === 'cell' ? '/cell/dashboard' :      // ✅ ADDED
//               userType === 'sector' ? '/sector/dashboard' :
//               userType === 'district' ? '/district/dashboard' :
//               userType === 'province' ? '/province/dashboard' :
//               userType === 'national' ? '/national/dashboard' : '/dashboard',
...
//               userType === 'citizen' ? Home :
//               userType === 'village' ? Home :
//               userType === 'cell' ? Building :              // ✅ ADDED
//               userType === 'sector' ? Building2 :           // Changed from Building
//               userType === 'district' ? Layers :
//               userType === 'province' ? Map :
//               userType === 'national' ? Globe : Home,
//         description: userType === 'admin' ? 'System overview' :
...
//         badge: 'Staff',
//         badgeColor: 'red',
//         requiredLevel: ['admin', 'village', 'cell', 'sector', 'district', 'province', 'national'], // ✅ ADDED 'cell'
//         subItems: [
//           {
//             name: 'All Incidents',
//             path: '/incidents/admin/list',
...
//             description: 'Currently handling'
//           },
//           // ✅ UPDATED: Escalation sub-item with Cell Level logic
//           {
//             name: userType === 'village' ? 'Escalated to Cell' :    // ✅ CHANGED (was 'to Sector')
//                   userType === 'cell' ? 'From Villages' :           // ✅ ADDED
//                   userType === 'sector' ? 'From Cells' :            // ✅ CHANGED (was 'From Villages')
//                   userType === 'district' ? 'From Sectors' :
//                   userType === 'province' ? 'From Districts' :
//                   userType === 'national' ? 'From Provinces' : 'Escalated',
//             path: userType === 'village' ? '/incidents/admin/list?escalated=true' :
//                   userType === 'cell' ? '/incidents/admin/list?escalated_from=village' :     // ✅ ADDED
//                   userType === 'sector' ? '/incidents/admin/list?escalated_from=cell' :      // ✅ CHANGED (was village)
//                   userType === 'district' ? '/incidents/admin/list?escalated_from=sector' :
//                   userType === 'province' ? '/incidents/admin/list?escalated_from=district' :
//                   userType === 'national' ? '/incidents/admin/list?escalated_from=province' :
//                   '/incidents/admin/list?view=escalations',
...
//             icon: Send,
//             description: `Incidents you escalated`,
//             requiredLevel: ['village', 'cell', 'sector', 'district', 'province'] // ✅ ADDED 'cell'
//           },
//           {
//             name: 'Track Escalated',
//             path: '/incidents/admin/list?escalated=true&track=true',
...
//             {/* Escalation Info - Fixed above user profile */}
//             {escalationTarget && (
//               <div className="p-4 border-t border-slate-700/50 bg-gradient-to-r from-orange-900/20 to-red-900/20 flex-shrink-0">
//                 <div className="flex items-center space-x-2 text-xs">
//                   <ArrowUp className="w-4 h-4 text-orange-400 flex-shrink-0" />
...
const Sidebar = ({ 
  ...
  const getAllNavigationItems = () => {
    ...
    return [
      ...
      // ==================== USER MANAGEMENT - High-Level Admin Access ====================
      {
        name: 'User Management',
        id: 'users',
        path: '/admin/users',
        ...
        badgeColor: 'red',
        requiredLevel: ['admin', 'national', 'province', 'district'] // ✅ UPDATED: Added national, province, district
      },

      // ==================== LOCATIONS - High-Level Admin Access ====================
      {
        name: 'Locations',
        id: 'locations',
        path: '/locations',
