...
const EditSafetyGuide = () => {
  ...
  const loadInitialData = async () => {
    try {
      ...
      setDisasterTypes(disasterTypesResponse.results || []);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError('Failed to update safety guide. Please try again.');
    } finally {
      setLoading(false);
    }
  };
              ...
              <div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  >
                    ...
                    {formData.featured_image ? 'Change Image' : 'Choose Image'}
                  </button>
                    ...
                    {formData.attachments.map((file, index) => (
                      <div key={index} className="flex items-center justify-between bg-gray-50 p-3 rounded-lg">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-sm text-gray-900">{file.name || `Attachment ${index + 1}`}</span>
                        </div>
                        <button
                          type="button"
